    ...
    return (
        ...
        <div className='bg-neutral-900 w-80 p-3 flex flex-col text-white'>
            <div className='flex items-center gap-2 px-1 py-3'>
              ...
              {/* <span className='text-neutral-100 text-2xl'>Breachseal Technologies</span> */}
              </div>
        ...
        onClick={() => handleLinkClick('/subscriptions')}><FontAwesomeIcon icon={faCog} /><span className="text-xl">Services</span></NavLink>
            </div>
            <div className="flex items-center  gap-2 text-xl px-3 py-2"><FontAwesomeIcon icon={faQuestionCircle}/><span>Help & Support</span></div>
            <div className="flex items-center gap-2 text-red-500 text-xl px-3 py-2">
